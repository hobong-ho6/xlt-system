...
# XLT System v3.0 macOS 전용 원클릭 설치 스크립트 (Python 자동 설치 포함)
...
echo -e "${BLUE}║          macOS 전용 설치 (Python 자동)       ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════╝${NC}"
echo ""
...
show_step() {
    ...
    echo -e "${PURPLE}[${step_counter}/9]${NC} $1"
    echo "────────────────────────────────────────"
}
...
handle_error() {
    ...
    echo "   3. 수동으로 Python을 설치해보세요: https://python.org"
    echo ""
