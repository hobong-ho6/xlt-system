        ...
        return new Promise((resolve) => {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3 text-center">
                                ...
                                <small class="text-muted d-block mt-1">텍스트 내용을 기반으로 XLT Key를 자동 생성합니다</small>
                            </div>
                            <div class="row">
                                <div class="col-12">
            ...
            document.getElementById('auto-generate-keys').addEventListener('click', () => {
                ...
                keyInputs.forEach((input, index) => {
                    ...
                    console.log(`Auto-generated key [${index}]: "${textContent.substring(0, 30)}..." → "${autoKey}"`);
                });
            });
    ...
    updateProgressUI(progress) {
        ...
        if (progress.total_languages && progress.completed_languages) {
            ...
            if (progressStatus) {
                ...
                progressStatus.textContent = `${completedCount}/${totalCount} 언어 번역 완료`;
            }
        }
